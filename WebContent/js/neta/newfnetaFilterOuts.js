...
sap.ui.model.json.JSONModel.extend("newfnetaFilterOuts", {
	...
	setInitialFilter : function(){
    	...
    	proCatModel.setSizeLimit(proCatFilterData.items.length);
    	...
    	proClassModel.setSizeLimit(proClassFilterData.items.length);
    	...
    	unitTypeModel.setSizeLimit(unitTypeFilterData.items.length);
...
//    	sap.ui.getCore().byId("idUnitTypeCombo").setModel(unitTypeModel);
    	...
    	mregionModel.setSizeLimit(mregionFilterData.items.length);
    	...
    	regionModel.setSizeLimit(regionFilterData.items.length);
    	...
    	countryModel.setSizeLimit(countryFilterData.items.length);
    	...
    	cityModel.setSizeLimit(cityFilterData.items.length);
    	...
    	depotModel.setSizeLimit(depotFilterData.items.length);
    	...
    	for(var j=0;j<FNASummaryArrayF4.length;j++){
    		if(FNASummaryArrayF4[j].Customer != ''){
    			customerFilterData.items.push({
    			"text":parseInt(FNASummaryArrayF4[j].Customer) + " - " + FNASummaryArrayF4[j].Customername,
    			"key":FNASummaryArrayF4[j].Customer
    		});
    		}
    	}
    	...
    	customerModel.setSizeLimit(customerFilterData.items.length);
    	...
    	leasetypeModel.setSizeLimit(leasetypeFilterData.items.length);
    	...
    	releasetypeModel.setSizeLimit(releasetypeFilterData.items.length);
...
//			var localSummaryArray = [];
		...
		resetEverything : function(){
        	...
        	mregionGModel.setSizeLimit(mregionFilterGData.items.length);
        	...
        	depotGModel.setSizeLimit(depotFilterGData.items.length);
        	...
        	proClassFilterGModel.setSizeLimit(proClassFilterGData.items.length);
        	...
        	customerFilterGModel.setSizeLimit(customerFilterGData.items.length);
        	...
        	leasetypeFilterGModel.setSizeLimit(leasetypeFilterGData.items.length);
        	...
        	releasetypeFilterGModel.setSizeLimit(releasetypeFilterGData.items.length);
